...
Payload unwrapping lives in ``ask_llm.core.response_parser`` (P4.7);
`_unwrap_translation_payload` remains as a thin static shim.
"""
        ...
        export_data: dict[str, Any] = {
            ...
            "statistics": {
                ...
                "failed_translations": sum(
                    1 for r in self.results if r.status == TaskStatus.FAILED
                ),
            },
        }
